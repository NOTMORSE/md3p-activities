...
fun main() {
    ...
    when (stringValue.toInt()) {
        1 -> {
            ...
            val num = Random.nextInt(0, 100000)
            print("Do you want to borrow the book? Y/N: ")
            val ans = readln().uppercase()
            when (ans.uppercase()) {
                "Y" -> print("Thank you, Please go to the front desk and show this reference number: \"$num\" to the front desk")
                else ->
        ...
        2 -> {
            ...
            val ans = readln().uppercase()
            when (ans.uppercase()) {
                "Y" -> println("Thank you, Please go to the front desk and show this reference number: \"$num\" to the front desk")
                else ->
                    println("Thank you for visiting the Library") }
        }
        3 -> {
